...
class Recommender:
    ...
    def compute_weighted_avg_embedding_of_keyphrases(self, keyphrase_infos):
        ...
        print(len("length of keyphrase info",keyphrase_infos))
    ...
    def post_retrieve_keyphrases(self,data,dnu_concepts,mid):
        ...
        for index, row in data.iterrows():
            ...
            if text:
                ...
                for kp, keyphrase_embedding in zip(row["keyphrases_infos"],row["individual_keyphrase_embeddings"]):
        ...
        data["keyphrases"] = data["keyphrases_infos"] 
