...
class Recommender:
    ...
    def compute_keyphrase_based_embeddings(self, data):
        ...
        def do(row):
            if len(row["keyphrase_embedding"]) < 1 or len(row.get("keyphrase_embedding", [])) < 1:
                ...
                keyphrases_avg_embedding+keyphrases_avg_embedding.to_list()
    ...
    def compute_weighted_avg_embedding_of_keyphrases(self, keyphrase_infos):
        ...
        for keyphrase in keyphrase_infos:
            ...
            individual_embeddings_list.append(embedding)
