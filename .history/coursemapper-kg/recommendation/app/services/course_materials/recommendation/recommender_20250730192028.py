            ...
            if text:
                ...
                for kp in extractor.get_n_best(n=15):
                    ...
                    for concept in concepts_nodes:
                        ...
                        keyphrase_similarity[concept["name"]]=compute_cosine_similarity_with_embeddings(keyphrase_embedding,concept["final_embedding"])
                ...
                for concept in concepts_nodes:
                    document_similarity[concept["name"]]=self.compute_cosine_similarity_with_text(concept["name"],text)
