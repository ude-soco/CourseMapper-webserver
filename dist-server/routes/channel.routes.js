...
module.exports = function (app) {
  ...
  app.post("/new-channel/:topicId", [authJwt.verifyToken, authJwt.isAdmin], controller.newChannel);
  app["delete"]("/channel/:channelId", [authJwt.verifyToken, authJwt.isAdmin], controller.deleteChannel);
};