...
class Document:
    def __init__(self, tagger_model: StanfordCoreNLPTagger, text: str = ""):
        """
        Document
        Arguments:
        ...
        """
        self.tokens, self.tagged_tokens = tagger_model.get_tokenized_words(text)
        self.grammar = """  NP:
                {<NN.*|JJ|HYPH>*<NN.*>}"""
        ...
        self.keyphrases_candidates = self.extract_candidates(self.tagged_tokens)
