...
class eva_compgcn:
    ...
    def data_load(self):
        model = SentenceTransformer('paraphrase-MiniLM-L12-v2')  #  may choose a different SBERT model paraphrase-MiniLM-L12-v2 paraphrase-MiniLM-L6-v2 all-MiniLM-L6-v2 paraphrase-xlm-r-multilingual-v1
        ...
        """ 
            Construct adj matrix and dict which used for storeing relation embedding
        """
        rows = []
        cols = []
        data_values = []
    ...
    def compgcn_direction_weight (self, rel_transform_mode = 'sub'):
        ...
        in_degrees = np.sum(adj_matrix_inverse, axis=1, keepdims=True)
        ...
        for edge in relation_embedding_matrix:
            relation_embedding_matrix[edge] =relation_embedding_matrix[edge] / np.linalg.norm(relation_embedding_matrix[edge], ord=1,keepdims=True)    
        """ 
        ...
        for v in range(embedding_matrix.shape[0]):
            degree = out_degrees[v]+in_degrees[v]
...
eva = eva_compgcn()
# print("++++++++++++++++++++++++++++Begin+++++++++++++++++++++++++++++++++++++")
# embedding1 = eva.embedding_matrix[7]
# embedding2 = eva.embedding_matrix[216]
# embedding4 = eva.embedding_matrix[4089]
# embedding3 = eva.relatin_embedding_matrix[(4137,6797)]
# similarity1_2 = cosine_similarity([embedding1], [embedding2])[0][0]
# similarity1_3 = cosine_similarity([embedding1], [embedding3])[0][0]
# similarity2_4 = cosine_similarity([embedding2], [embedding4])[0][0]
# similarity1_4 = cosine_similarity([embedding1], [embedding4])[0][0]
# print(similarity1_2)
# print(similarity2_4)  
# print(similarity1_4)
# score1=transE_score(embedding1, eva.relatin_embedding_matrix[(7,216)],embedding2)
# score2=transE_score(embedding1, eva.relatin_embedding_matrix[(4137,6797)],embedding4)
# print(score1)
# print(score2)
# print("+++++++++++++++++++++++++++++END++++++++++++++++++++++++++++++++++++")
eva.edges = list(set(eva.edges))
# print(len(eva.edges))
# print(type(eva.edges))
embedding_7 = eva.embedding_matrix[7]
embedding_150 = eva.embedding_matrix[150]
eva.compgcn_direction_weight('corr')
embedding_new_7 = eva.final_embedding_matrix[7]
embedding_new_150= eva.final_embedding_matrix[150]
...
# embedding_height = 12
# embedding_width = 32 
# convE_model = ConvEScorer(embedding_dim, embedding_height, embedding_width)
...
# embedding1 = embedding_matrix[7]
# embedding2 = embedding_matrix[216]
# embedding4 = embedding_matrix[4089]
# embedding3 = relation_embedding_matrix[(4137,6797)]
# similarity1_2 = cosine_similarity([embedding1], [embedding2])[0][0]
# similarity1_3 = cosine_similarity([embedding1], [embedding3])[0][0]
# similarity2_4 = cosine_similarity([embedding2], [embedding4])[0][0]
# similarity1_4 = cosine_similarity([embedding1], [embedding4])[0][0]
