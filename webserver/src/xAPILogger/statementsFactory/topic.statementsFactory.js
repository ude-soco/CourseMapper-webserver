...
export const getTopicDeletionStatement = (user, course) => {
    const fullname = `${user.firstname} ${user.lastname}`;
    return 
}

export const getTopicAccessStatement = (user, course) => {
    const fullname = `${user.firstname} ${user.lastname}`;
    return 
}

export const getTopicEditStatement = (user, newCourse, oldCourse) => {
    const fullname = `${user.firstname} ${user.lastname}`;
    return 
}