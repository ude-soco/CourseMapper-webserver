  ...
  try {
    ...
    if (!user) {
      ...
      let mailDetails = {
        ...
        <a href="${process.env.WEBAPP_URL}/restPassword/${token}"> here  </a> to reset your password. If the above link does not work copy and paste this link into your browser: https://${process.env.WEBAPP_URL}/restPassword/${token}</p>
  ...
  let token = req.body.token;
    ...
    let mailDetails = {
      ...
      html: `<html>
        ...
        <body>
        <p>Dear ${user.username},</p>
        <p>Thank you for registering with CourseMapper. Please click <a href="${process.env.WEBAPP_URL}/verify/${token}">here</a> to verify your email address. If the above link doesn't work, copy and paste this link into your browser: https://${process.env.WEBAPP_URL}/verify/${token}</p>
        <p>Please note that this link is only valid for 24 hours. If you did not register, please ignore this email.</p>
        <p>Regards,</p>
        <p>The CourseMapper Team</p>
        </body>
