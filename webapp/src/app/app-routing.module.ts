...
import { TagsPageComponent } from './pages/components/annotations/tags/tags-page/tags-page.component';
...
const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      //   path: 'tag',
      //   loadChildren: () =>
      //   import('./pages/components/annotations/annotation.module').then(m => m.AnnotationModule)
      // },
    ],
  },
