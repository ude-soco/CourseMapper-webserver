...
export const setZoomIn = createAction('[Annotation] Set Pdf Zoom In Value');

export const setZoomOut = createAction('[Annotation] Set Pdf Zoom Out Value');

export const resetZoom = createAction('[Annotation] Reset Pdf Zoom Value');
...
export const postReplySuccess = createAction('[Annotation] Post Reply Success');
...
export const likeReplySuccess = createAction('[Annotation] Like Reply Success');
...
export const editReply = createAction(
  '[Reply] Edit Reply',
  props<{ reply: Reply; updatedReply: string;  mentionedUsers: { userId: string; name: string; username: string }[] }>()
);
...
export function LoadTagsSuccess(arg0: {
