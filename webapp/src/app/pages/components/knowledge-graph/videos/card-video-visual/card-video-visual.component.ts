...
@Component({
  selector: 'app-card-video-visual',
  templateUrl: './card-video-visual.component.html',
  styleUrls: ['./card-video-visual.component.css'],
})
export class CardVideoComponentVisual {
  constructor(
